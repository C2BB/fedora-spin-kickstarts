...
repo --name=updates --baseurl=http://download.fedoraproject.org/pub/fedora/linux/updates/$releasever/$basearch/ --excludepkgs=bluez*,openssl,wpa_supplicant,curl,libdrm,sbc
